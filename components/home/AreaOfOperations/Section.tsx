            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 mb-8">
                {section.images.slice(0, 2).map((src, i) => (
                  <div
                    key={i}
                    className="relative overflow-hidden rounded-xl shadow-md h-[220px] w-full sm:w-[350px] transition-transform hover:-translate-y-3 hover:shadow-xl hover:cursor-pointer"
                  >
