...
export default function AreaOfOperations({ sections }: AreaOfOperationsProps) {
  ...
  return (
    <section className="bg-gradient-to-r w-full from-pink-50 via-white to-orange-50 pt-[80px] pb-[80px]">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 mb-8">
                {section.images.slice(0, 2).map((src, i) => (
                  <div
                    key={i}
                    className="relative overflow-hidden rounded-xl shadow-md h-[220px] w-[358px] sm:w-[350px] transition-transform hover:-translate-y-3 hover:shadow-xl mx-auto"
                  >
