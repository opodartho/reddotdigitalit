...
export default function HeroSection() {
    return (
        <section className="flex flex-col gap-6 max-w-xl pl-10">
            {/* Badges */}
            <div className="flex flex-wrap gap-2">
                {["15+ enterprise solutions", "ISO Certified", "5+ years of experience"].map((text) => (
                    <span
                        key={text}
                        className="px-3 py-1 text-xs font-medium bg-gray-100 text-[#70738F]; rounded-full"
                    >
                        {text}
                    </span>
                ))}
            ...
            <h1 className="text-5xl font-bold leading-tight">
                Crafting{" "}
                <span className="text-[#E52445]">Innovation,</span>
                <br />
