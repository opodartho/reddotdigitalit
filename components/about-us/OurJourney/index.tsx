...
export default function OurJourney({ journeyData }: JourneyProps) {
    return (
        <>
            <div className="lg:pt-[148.76px] pt-[58.95px] lg:flex lg:flex-col lg:justify-center">
                <div className="lg:flex lg:flex-col flex flex-col items-center lg:text-center text-left ">
                    ...
                    <p className=" max-h-[179px] text-[14px] lg:block lg:max-w-7xl hidden text-subtitle">RedDot Digital Limited is the 100% subsidiary of Robi Axiata Limited, the second largest telecom operator in Bangladesh, which is currently owned by two key stakeholder - Axiata and Bharti Airtel. RedDot Digital Limited was incorporated in 2019 to provide B2B clients with IT operations.</p>
                    <p className=" text-center max-h-[179px] text-[14px] lg:hidden text-subtitle">RedDot Digital Limited is the 100% subsidiary of Robi Axiata Limited, the second largest telecom operator in Bangladesh </p>
