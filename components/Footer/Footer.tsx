    ...
    <footer className="bg-gradient-to-b from-slate-100 via-violet-100 to-violet-100 font-poppins mt-20 px-[16px] sm:px-[80px]">
      <FooterAnimatedSection>
        ...
        <div className="max-w-[1440px] mx-auto py-12">
          <FooterAnimatedItem className="flex justify-center mb-12">
            <Image
              src={logoUrl}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-22 gap-y-16">
            {columns.map((column) => {
              ...
              return (
                <FooterAnimatedItem key={column.title} className={extraPadding}>
        ...
        <FooterAnimatedItem className="py-6 border-t border-slate-800/10">
