...
export function WhiteHoverButton({
  ...
  return (
    ...
    >
      ...
      <div className=" bg-white text-[#E52445] absolute top-0 z-10 flex h-full w-full translate-x-14 items-center justify-center gap-2 opacity-0 transition-all duration-300 group-hover:-translate-x-5 group-hover:opacity-100">
        <span>{children}</span>
        <ArrowRight />
      </div>
    </button>
